              ...
              <div className="w-72">
                ...
                <form className="mt-4">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="password" placeholder="*****" className="block w-full rounded-md border border-gray-300 focus:border-pink-700 focus:outline-none focus:ring-1 focus:ring-purple-700 py-1 px-1.5 text-gray-500" />
                  </div>
                  ...
                  <div className="mb-3">
                    <button className="mb-1.5 block w-full text-center text-white bg-pink-300 hover:bg-pink-900 px-2 py-1.5 rounded-md">Sign in</button>
                ...
                <div className="text-center">
                  ...
                  <a href="#" className="text-xs font-semibold text-purpiple-700">Sign up</a>
                </div>
              </div>
            </div>
